        ...
        <div className="flex flex-col lg:flex-row lg:space-x-8">
          ...
          <div className="lg:w-3/5 xl:w-7/12 mb-8 lg:mb-0">
            <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 h-96 sm:h-[400px] lg:h-[500px] flex items-center justify-center overflow-hidden">
              <img
                src="/certificates/nvidia-ai-anomaly-detection.png"
                alt="Applications of AI for Anomaly Detection certificate"
            ...
            <div className="p-0">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Certification focusing on implementing AI-powered anomaly detection systems for various applications and industries.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Statistical Analysis</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Real-time Processing</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">AI Monitoring</span>
                </div>
              </div>
            </div>
          </div>
