        ...
        <div className="flex flex-col lg:flex-row lg:space-x-8">
          ...
          <div className="lg:w-3/5 xl:w-7/12 mb-8 lg:mb-0">
            <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 h-96 sm:h-[400px] lg:h-[500px] flex items-center justify-center overflow-hidden">
              <img
                src="/certificates/nvidia-ai-predictive-maintenance.png"
                alt="Applications of AI for Predictive Maintenance certificate"
            ...
            <div className="p-0">
              ...
              <div className="space-y-4 mb-8">
                <div>
                  ...
                  <p className="text-base font-semibold text-gray-700">AI Applications</p>
                </div>
                <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Specialized certification on applying AI techniques for predictive maintenance in industrial and IoT environments.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Predictive Analytics</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">IoT</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Time Series Analysis</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Anomaly Detection</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Industrial AI</span>
                </div>
              </div>
            </div>
          </div>
