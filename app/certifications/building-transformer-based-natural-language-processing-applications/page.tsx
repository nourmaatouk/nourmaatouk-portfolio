    ...
    <div className="min-h-screen bg-[#f4f7f9] py-6 px-2 sm:px-8">
      <div className="max-w-6xl mx-auto bg-white p-6 sm:p-10 rounded-xl shadow-xl">
        ...
        <header className="text-center mb-10">
          <p className="text-sm font-semibold text-gray-500 tracking-wider uppercase mb-1">Deep Learning</p>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-4">
            Building Transformer-Based Natural Language Processing Applications
          </h1>
          <div className="flex justify-center items-center text-gray-600 text-sm space-x-4">
            <span className="flex items-center">
              {/* NVIDIA Icon (simple square for placeholder) */}
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-8">
          ...
          <div className="lg:w-3/5 xl:w-7/12 mb-8 lg:mb-0">
            <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 h-96 sm:h-[400px] lg:h-[500px] flex items-center justify-center overflow-hidden">
              <img
                src="/building-transformer-based-natural-language-processing-applications.jpg"
                alt="Building Transformer-Based Natural Language Processing Applications certificate"
            ...
            <div className="p-0">
              ...
              <div className="space-y-4 mb-8">
                <div>
                  ...
                  <p className="text-base font-semibold text-gray-700">Deep Learning</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Issuing organization:</p>
                  <p className="text-base font-semibold text-gray-700">NVIDIA</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Issue date:</p>
                  <p className="text-base font-semibold text-gray-700">Sep 2024</p>
                </div>
                <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Advanced certification focusing on building and deploying transformer-based NLP applications using NVIDIA's technology stack.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Transformers</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">BERT</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">GPT</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">NLP</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Deep Learning</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">NVIDIA Rapids</span>
                </div>
              </div>
            </div>
          </div>
