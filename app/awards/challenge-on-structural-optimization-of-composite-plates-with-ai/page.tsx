          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 bg-gray-800 text-white rounded-lg p-6">
              ...
              <div className="space-y-4 text-sm leading-relaxed">
                <p>
                  Collaborated with EPT/Lasmap to tackle complex structural engineering challenges using artificial intelligence. Our solution employed deep learning algorithms to optimize the design of composite plates, balancing strength, weight, and cost factors.
                </p>
                
                <p>
                  The AI model learned from thousands of simulation results to suggest optimal fiber orientations and layer configurations. This approach reduced design iteration time by 70% and produced lighter, stronger composite structures.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-8">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm font-semibold text-blue-900">ARSII & EPT/Lasmap - University of Carthage</p>
                  </div>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-purple-900">May 2024</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Won first place for developing AI-driven solutions for structural optimization of composite plates, improving material efficiency and performance.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Deep Learning</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">FEA Simulation</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Optimization Algorithms</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Material Science</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">TensorFlow</span>
                </div>
              </div>
            </div>
          </div>
