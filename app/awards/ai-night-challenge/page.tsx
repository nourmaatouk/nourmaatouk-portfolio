        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-400 rounded-2xl overflow-hidden">
              <img
                src="/ai-night-challenge.jpg"
                alt="AI Night Challenge"
            ...
            <div className="mt-6 bg-gray-800 text-white rounded-lg p-6">
              ...
              <div className="space-y-4 text-sm leading-relaxed">
                <p>
                  An intense 24-hour hackathon where teams competed to develop innovative AI solutions. Our team created an AI-powered smart city traffic management system that optimizes traffic flow in real-time.
                </p>
                
                <p>
                  Using computer vision and reinforcement learning, the system analyzes traffic patterns and dynamically adjusts traffic signals to reduce congestion. The solution demonstrated a 40% reduction in average wait times during simulations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-8">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm font-semibold text-blue-900">ARSII & Novation City</p>
                  </div>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-purple-900">March 2024</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Champion of the AI Night Challenge, showcasing innovative artificial intelligence solutions developed under time constraints.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Reinforcement Learning</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Real-time Processing</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Smart Cities</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">OpenCV</span>
                </div>
              </div>
            </div>
          </div>
