        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-400 rounded-2xl overflow-hidden">
              <img
                src="/ias-tam-4-0-technical-challenge.jpg"
                alt="IAS TAM 4.0 Technical Challenge"
            ...
            <div className="mt-6 bg-gray-800 text-white rounded-lg p-6">
              ...
              <div className="space-y-4 text-sm leading-relaxed">
                <p>
                  Competed in this prestigious IEEE challenge focused on Industry 4.0 transformation. Our team developed a comprehensive predictive maintenance system for industrial equipment using IoT sensors and machine learning.
                </p>
                
                <p>
                  The solution integrated real-time data collection, anomaly detection, and predictive analytics to minimize equipment downtime. Our system achieved 95% accuracy in predicting equipment failures up to 48 hours in advance, potentially saving millions in maintenance costs.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-8">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm font-semibold text-blue-900">IEEE Industrial Applications Society & DATAVERSE</p>
                  </div>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-purple-900">April 2024</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Secured first place in the IAS TAM 4.0 Technical Challenge, demonstrating expertise in Industry 4.0 technologies and data-driven industrial applications.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Predictive Maintenance</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Time Series Analysis</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Industrial AI</span>
                  <span className="px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded">Cloud Computing</span>
                </div>
              </div>
            </div>
          </div>
